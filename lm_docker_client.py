...
lm_docker_socket class used to build socket connection to the server.

__init__: 
	args is the dst_ip, build socket.
send_file:
	send the checkpoint file.
send_msg:
	send the message to help server distinguish the file type.(like dump,fs,pre-dump...)
recv_msg:
